...
ori_pos_x = -0.14  # original leg's sensor position in x-axis; unit: m
...
max_ROM_z = 0.48  # change this variable according to the selected movement; unit: m
ori_pos_z = 0.33  # original leg's sensor height; unit: m
...
max_ROM_y = 0.17  # change this variable according to the selected movement; unit: m
ori_pos_y = 0.09  # original leg's sensor position in y-axis; unit: m
