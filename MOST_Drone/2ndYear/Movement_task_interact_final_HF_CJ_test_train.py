...
ori_pos_x = -0.13  # original leg's sensor position in x-axis; unit: m
...
max_ROM_z = 0.85  # change this variable according to the selected movement; unit: m
ori_pos_z = 0.56  # original leg's sensor height; unit: m
...
ori_pos_y = -0.05  # original leg's sensor position in y-axis; unit: m
